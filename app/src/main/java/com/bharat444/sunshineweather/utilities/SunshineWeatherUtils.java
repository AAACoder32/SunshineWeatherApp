...
import com.bharat444.sunshineweather.data.SunshinePreferences;
public final class SunshineWeatherUtils
{

	private static double celciusToFahrenheit(double temperatureInCelcius)
	{
		double temperatureInFahrenheit = (temperatureInCelcius * 1.8) + 32;
		return temperatureInFahrenheit;
	}

	public static String formatTemprature(Context context, double temperature)
	{
	...
	public static String formatHighLow(Context context, double high, double low)
	{
		...
		String formattedHigh = formatTemprature(context, high);
		String formattedLow = formatTemprature(context, low);
